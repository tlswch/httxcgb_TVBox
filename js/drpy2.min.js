import cheerio from "https://agit.ai/txcgb/dr_py/raw/branch/master/libs/cheerio.min.js";
import "https://agit.ai/txcgb/dr_py/raw/branch/master/libs/crypto-js.js";
import模板from "https://agit.ai/txcgb/dr_py/raw/branch/master/js/模板.js";
...
const URLJOIN_ATTR = /(url|src|href|-original|-src|-play|-url)$/;
...
function searchParse(searchObj) {
    ...
    let url = searchObj.searchUrl.replaceAll("**", searchObj.wd)
        .replaceAll("fypage", searchObj.pg);
    MY_URL = url;
    console.log(MY_URL);
    if (p.startsWith("js:")) {
        const TYPE = "search";
